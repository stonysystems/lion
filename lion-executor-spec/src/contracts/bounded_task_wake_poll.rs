...
//            `single_progress_has_drain_task_wake` proves every progress step
//            contains at least one Drain{{TaskWake}}; composed consumes it from
...
// TaskWake queue; the proof of that contract is the pair above. Before deleting
